    ...
    def _summarize():
        try:
            ...
            if count > 50:
                ...
                # Here we would:
                # 1. Fetch messages N-50 to N-20
                # 2. Call a lightweight Gemini model to generate a summary
                # 3. Store the summary back in history or long-term memory
                # 4. Delete the raw messages
                pass
